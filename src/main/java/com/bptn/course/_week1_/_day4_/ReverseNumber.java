...
last value, what I had to do is to run a whileloop to loop through the end of each value. What I'm going to take 
away from this lession is how to use % and to get the last value of a number by doing % 10. 
*/