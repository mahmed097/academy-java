...
public class Person {
	...
	// Get method to get firstName
	public String getFirstName() {
		return firstName;
	}

	// Get method to get lastName
	public String getLastName() {
		return lastName;
	}

	// Set method to update firstName
	public void setFirstName(String firstName) {
		this.firstName = firstName;
	}

	// Set method to update lastName
	public void setLastName(String lastName) {
		this.lastName = lastName;
	}

	// Birthday method to return birthday in Month/Day/Year format
	public String getBirthday() {
		return birthMonth + "/" + birthDay + "/" + birthYear;
	}

	// Method to verify ssn number
